                          ...
                          <div class="modal-body">
                              ...
                              <form action="valida-login.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "usuario" required="required" class="form-control" id="txUsuario">

                                </div>
                                <div class="form-group">
                                    <label for="txSenha">Senha</label>
                                    <input type="password" name="senha" class="form-control" required="required" id="txSenha">
                                </div>
                                <hr>

...
<div class="container lista-de-usuarios">
      ...
      <tr>
        ...
        <td>
          <div style="float:left">
            ...
            <div class="modal fade" id="myModalRemarks<?php echo $row['nome_produto'];?>" tabindex="-1" role="dialog"
  ...
  <nav>
    <ul class="pagination justify-content-end">
      ...
      <li class="page-item"><a class="page-link" href='pagina_de_listagem.php?pagina=<?php echo $i;?>'>
          <?php echo $i;?></a></li>
      <?php } 
            }
      ?>
